...
public class EnemyAttack : MonoBehaviour
{
    ...
    private void TryAttack()
    {
        ...
        Vector2 origin = (Vector2)transform.position + Vector2.down * 0.3f; // Çizgiyi biraz aşağıya çek
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        Vector2 direction = transform.localScale.x > 0 ? Vector2.right : Vector2.left;
        Vector2 origin = (Vector2)transform.position + Vector2.down * 0.6f; // Çizgiyi biraz aşağıya çek
